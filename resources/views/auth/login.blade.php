...
<div class="wrapper-page">
    ...
    <div class="m-t-40 card-box">
        <div class="text-center">
            ...
            <div class="text-center">
                <a href="index.html" class="logo"><span style="color: #61372b !important"><img src="{{asset('adminto/images/brand/brand-name.png')}}" alt="logo" title="" class="logo " width="150px" ></a>
