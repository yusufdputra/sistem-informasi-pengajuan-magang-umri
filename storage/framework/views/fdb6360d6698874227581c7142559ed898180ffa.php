...
<div class="wrapper-page">
    ...
    <div class="m-t-40 card-box">
        <div class="text-center">
            ...
            <div class="text-center">
                <a href="index.html" class="logo"><span style="color: #61372b !important"><img src="<?php echo e(asset('adminto/images/brand/brand-name.png')); ?>" alt="logo" title="" class="logo " width="150px" ></a>
                <h5 class="text-muted m-t-0 font-600" style="color: #61372b !important">Sistem Informasi Pengenalan Lapangan Persekolahan</h5>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SIMA UP2KT\resources\views/auth/login.blade.php ENDPATH**/ ?>